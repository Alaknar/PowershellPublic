...
Function Get-MgDevicePlatformScipts {
    <#
.SYNOPSIS
Get all or individual Intune PowerShell Platform Scripts and save them in specified folder.
 
.DESCRIPTION
The Get-MgDevicePlatformScipts.ps1 cmdlet downloads all or individual PowerShell scripts from Intune to a specified folder.
Initial Author: Oliver Kieselbach (oliverkieselbach.com)
Compatibility with Microsoft.Graph.Authentication and error handling: Alaknár (https://github.com/Alaknar)
...
Get-MgDevicePlatformScipts.ps1 -FolderPath C:\temp 

.EXAMPLE
Download an individual PowerShell script to the specified folder

Get-MgDevicePlatformScipts.ps1 -FolderPath C:\temp -FileName myScript.ps1
